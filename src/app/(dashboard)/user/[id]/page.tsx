...
export async function generateMetadata({
  ...
  return {
    title: data ? `${data.full_name} - Detail User` : "Detail User",
  };
}
        ...
        {!data || error ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {error ?? "User tidak tersedia atau gagal dimuat."}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Informasi lengkap data user yang diambil dari getUserDetailAction.
              </CardDescription>
            </CardHeader>
            <Separator />
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Data identitas dan kontak user.</p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Info singkat user dan metadata akun.</p>
                </div>
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                  <InfoRow
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Daftar alamat yang tersimpan untuk user ini.</p>
                </div>
                {data.address?.length ? (
                  <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Informasi pembuat dan pengubah data user.</p>
                </div>
